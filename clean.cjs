...
const dir = '/Users/musa/Downloads/proyectos recientes/RECUPERAR MYNEXT WEB✔️/mynext-V3✔️';
const files = [
    path.join(dir, 'index.html'),
    path.join(dir, 'index-en.html'),
    path.join(dir, 'planes/index.html'),
    path.join(dir, 'planes/index-en.html')
];
